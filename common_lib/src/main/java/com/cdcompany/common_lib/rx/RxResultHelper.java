...
import com.cdcompany.common_lib.rx.error.NetworkConnectionException;
import com.cdcompany.common_lib.rx.error.ServerException;
                        ...
                        new Func1<ApiResponse<T>, Observable<T>>() {
                            ...
                            public Observable<T> call(ApiResponse<T> tApiResponse) {
                                if (tApiResponse == null) {
                                    ...
                                    return Observable.error(new ServerException(tApiResponse.getError_code(),tApiResponse.getReason()));
                                }
                            }
                        }
                );
